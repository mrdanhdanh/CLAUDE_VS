...
description: "Task-agnostic lessons 'Governance & Verifier Integrity' chưng cất từ docs/knowleged.md (2 KN: KN-012, KN-021) + .agent/bugs/. Use when task chạm process, governance, tdd, safety, reward-hacking, security, rbac — áp Cách phòng tránh trước khi code, tránh lặp bug cũ. DisCo-lite, regenerate bằng distill-agnostic.mjs."
...
- Task chạm theme **Governance & Verifier Integrity** (tags: process, governance, tdd, safety, reward-hacking, security, rbac)
...
- `docs/knowleged.md` — KN-012, KN-021
