...
> **Error:** `GitHub Pages deploy fail - 2 workflows cung environment github-pages`
> **File:** `.github/workflows/ai-news.yml`
> **Title:** pages deploy conflict 2 workflows

# Bug: pages deploy conflict 2 workflows

> Copy file này vào `.agent/bugs/2026-09-04-pages-deploy-conflict-2-workflows/bug.md` khi bắt đầu `/fixbug`.

## Meta

- **Slug:** `2026-09-04-<slug>` (vd: `2026-08-29-modal-esc`)
- **Ngày:** YYYY-MM-DD
