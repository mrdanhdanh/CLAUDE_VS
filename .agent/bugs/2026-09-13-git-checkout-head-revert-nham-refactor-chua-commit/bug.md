...
# Bug: git checkout HEAD revert nham refactor chua commit - recover bang VSCode local history

> Copy file này vào `.agent/bugs/2026-09-13-git-checkout-head-revert-nham-refactor-chua-commit/bug.md` khi bắt đầu `/fixbug`.

## Meta

- **Slug:** `2026-09-13-<slug>` (vd: `2026-08-29-modal-esc`)
- **Ngày:** YYYY-MM-DD
