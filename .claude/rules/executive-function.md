<!-- generated by harness-manager export-claude — DO NOT EDIT, edit .github/instructions/executive-function.instructions.md instead -->
...
| **Working memory** | quên giữa chừng, lặp lại việc đã làm | `TodoWrite`, `.agent/plans/<task>/`, `docs/knowleged.md`, session log |
...
| **Tự giám sát** | "tưởng xong" nhưng chưa; overconfidence | Verify + Evals Gate (KN-037) + Slop Gate (KN-047), `IDE diagnostics`, audit chain |
